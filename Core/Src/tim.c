...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, ENCODER4_1_Pin|ENCODER4_2_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, ENCODER2_1_Pin|ENCODER2_2_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PF7     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOF, ENCODER3_2_Pin|ENCODER3_1_Pin);
