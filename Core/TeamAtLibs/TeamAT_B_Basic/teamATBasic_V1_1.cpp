 ...
 * V1.1.1
 *	  - Added stio.h / stdint.h
 *    - Changed / corrected type in millisToHumanTime
 */
...
/**
 * @brief This functions reads bit 
 *      
 * 	
 ...
 */
uint8_t bitRead_teamat(uint8_t data, uint8_t bitNum)
{
	return 1 && (data & (1 << bitNum));
}